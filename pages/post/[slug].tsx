...
const Post = ({ post }: Props) => {
    ...
    return (
        <main>
            ...
            {submitted ?
                (
                    <div className="flex flex-col p-10 my-10 text-center bg-yellow-500 text-white max-w-2xl mx-auto">
                        <h3 className="text-3xl pb-2 font-bold">Thanks you for submitting your comment!</h3>
